...
/** Class for the first level extends GLevel attributes/methods and implements ActionListener class (from Timer library). */
public class Level1 extends GLevel implements ActionListener{
    private int totalCoins=1;
    private int ni=0;
    private Vec2 lastPlatform;
    private World world;
    private Timer metTimer;
    private int numOfMeteors=1;
    ...
    public void populate(Game game) {
        ...
        for(ni=0; ni<50; ni++){
            ...
            lastPlatform = platform1.getPosition();
        }
        {
