...
/** Class for the fourth level extends GLevel attributes/methods and implements ActionListener class (from Timer library). */
public class Level4 extends GLevel implements ActionListener{
    private int totalCoins = 10;
    private int ni=0;
    private int newMHeight;
 ...
 */
    ...
    public void populate(Game game) {
        ...
        while(ni<10){
            ...
            platform1.setPosition(new Vec2(20,newMHeight));            
            ni++;
