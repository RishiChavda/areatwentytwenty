...
/** Class for the second level extends GLevel attributes/methods and implements ActionListener class (from Timer library). */
public class Level2 extends GLevel implements ActionListener {
    private int totalCoins = 2;
    private int ni=0;
    private int newHeight,newMHeight;
    private Timer metTimer;
    private int numOfMeteors=2;
 ...
 */
    ...
    public void populate(Game game) {
        ...
        while(ni<10){
            ...
            Platform platform3 = new Platform(this.getPlayer().getWorld());
            platform3.setPosition(new Vec2(20,newMHeight));            
            ni++;
            newHeight=newHeight+10;
            newMHeight=newMHeight+10;
        }
        {
